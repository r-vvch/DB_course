...
/*1. ¬ыбрать имена всех таблиц, созданных назначенным пользователем базы данных (например, пользователем s33 дл€ базы d33)*/
	SELECT name
	FROM sys.objects
	WHERE type = 'U'
...
/*2. ¬ыбрать им€ таблицы, им€ столбца таблицы, признак того, допускает ли данный столбец null-значени€, название типа данных столбца
  таблицы, размер этого типа данных - дл€ всех таблиц, созданных назначенным пользователем базы данных и всех их столбцов*/
...
/*4. ¬ыбрать название внешнего ключа, им€ таблицы, содержащей внешний ключ, им€ таблицы,
	содержащей его родительский ключ - дл€ всех внешних ключей, созданных назначенным пользователем базы данных*/
...
/*6. ¬ыбрать название триггера, им€ таблицы, дл€ которой определен триггер - дл€ всех триггеров,
	созданных назначенным пользователем базы данных*/
